      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg">
            ...
            working with JavaScript, React, Node.js, Express, MySQL, Mongo, HTML, CSS, and Git. I am a quick learner and I am always looking to expand my knowledge and skill set. I left a career in legal compliance, a detail-oriented and fast paced enviroment, to pursue programaming, which had up to that point only been a hobby. I am excited to work with other developers going forward. 
          </p>
